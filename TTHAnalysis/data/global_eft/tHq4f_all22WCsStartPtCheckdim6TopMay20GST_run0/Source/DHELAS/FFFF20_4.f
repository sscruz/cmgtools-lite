...
C     jP(-5,3)*ProjP(-3,1)
C     
      SUBROUTINE FFFF20_4(F1, F2, F3, COUP, M4, W4,F4)
      IMPLICIT NONE
      COMPLEX*16 CI
     ...
     $ * W4))
      F4(3)= DENOM*8D0 * CI*(F2(5)*(F1(5)*F3(6)*(+CI*(P4(2))-P4(1))
     $ +F1(6)*F3(5)*(P4(1)-CI*(P4(2))))+F2(6)*(F1(5)*F3(6)*(P4(3)-P4(0)
     $ )+F1(6)*F3(5)*(P4(0)-P4(3))))
      F4(4)= DENOM*8D0 * CI*(F2(5)*(F1(5)*F3(6)*(P4(0)+P4(3))-F1(6)
     $ *F3(5)*(P4(0)+P4(3)))+F2(6)*(F1(5)*F3(6)*(P4(1)+CI*(P4(2)))
     $ -F1(6)*F3(5)*(P4(1)+CI*(P4(2)))))
      F4(5)= DENOM*8D0 * CI * F2(6)*M4*(F1(6)*F3(5)-F1(5)*F3(6))
