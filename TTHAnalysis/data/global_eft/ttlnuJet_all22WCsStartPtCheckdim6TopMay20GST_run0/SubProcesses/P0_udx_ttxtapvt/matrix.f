...
C     
C     Process: u d~ > t t~ ta+ vt DIM6<=1 FCNC=0
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV2_1(W(1,6),W(1,7),GC_649,MDL_MTA,ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,5),W(1,9),W(1,8),GC_3,AMP(1))
      CALL FFV11_9P0_3(W(1,4),W(1,3),GC_813,GC_814,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,5),W(1,9),W(1,10),GC_3,AMP(2))
      CALL FFV2_8_3(W(1,4),W(1,3),GC_651,GC_660,MDL_MZ,MDL_WZ,W(1,11))
      CALL FFV2_2(W(1,5),W(1,7),GC_649,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,12),W(1,6),W(1,11),GC_664,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV2_7_0(W(1,5),W(1,9),W(1,11),GC_650,GC_661,AMP(4))
      CALL FFV11_9_3(W(1,4),W(1,3),GC_721,GC_722,MDL_MZ,MDL_WZ,W(1,13))
C     Amplitude(s) for diagram number 5
      CALL FFV2_0(W(1,12),W(1,6),W(1,13),GC_664,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_7_0(W(1,5),W(1,9),W(1,13),GC_650,GC_661,AMP(6))
      CALL FFV4_3(W(1,4),W(1,3),GC_948,MDL_MZ,MDL_WZ,W(1,14))
C     Amplitude(s) for diagram number 7
      CALL FFV2_0(W(1,12),W(1,6),W(1,14),GC_664,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV2_7_0(W(1,5),W(1,9),W(1,14),GC_650,GC_661,AMP(8))
      CALL FFV2_3(W(1,4),W(1,3),GC_938,MDL_MZ,MDL_WZ,W(1,15))
C     Amplitude(s) for diagram number 9
      CALL FFV2_0(W(1,12),W(1,6),W(1,15),GC_664,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV2_7_0(W(1,5),W(1,9),W(1,15),GC_650,GC_661,AMP(10))
      CALL FFS2_4_3(W(1,4),W(1,3),GC_739,GC_738,MDL_MH,MDL_WH,W(1,12))
C     Amplitude(s) for diagram number 11
      CALL FFS4_0(W(1,5),W(1,9),W(1,12),GC_955,AMP(11))
      CALL FFS4_3(W(1,4),W(1,3),GC_954,MDL_MH,MDL_WH,W(1,16))
C     Amplitude(s) for diagram number 12
      CALL FFS4_0(W(1,5),W(1,9),W(1,16),GC_955,AMP(12))
      CALL FFV2_3(W(1,5),W(1,6),GC_649,MDL_MW,MDL_WW,W(1,9))
C     Amplitude(s) for diagram number 13
      CALL VVV1_0(W(1,8),W(1,7),W(1,9),GC_4,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL VVV1_0(W(1,10),W(1,7),W(1,9),GC_4,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL VVV1_0(W(1,7),W(1,9),W(1,11),GC_653,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL VVV1_0(W(1,7),W(1,9),W(1,13),GC_653,AMP(16))
C     Amplitude(s) for diagram number 17
      CALL VVV1_0(W(1,7),W(1,9),W(1,14),GC_653,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL VVV1_0(W(1,7),W(1,9),W(1,15),GC_653,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL VVS1_0(W(1,7),W(1,9),W(1,12),GC_730,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL VVS1_0(W(1,7),W(1,9),W(1,16),GC_730,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL FFVV2_4_0(W(1,4),W(1,3),W(1,7),W(1,9),GC_735,GC_734,AMP(21))
      CALL FFV2_1(W(1,3),W(1,7),GC_649,MDL_MB,ZERO,W(1,16))
C     Amplitude(s) for diagram number 22
      CALL FFV2_0(W(1,4),W(1,16),W(1,9),GC_649,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV4_0(W(1,4),W(1,16),W(1,9),GC_923,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV10_3_0(W(1,4),W(1,16),W(1,9),GC_767,GC_742,AMP(24))
C     Amplitude(s) for diagram number 25
      CALL FFV2_0(W(1,4),W(1,16),W(1,9),GC_740,AMP(25))
      CALL FFV4_1(W(1,3),W(1,7),GC_924,MDL_MB,ZERO,W(1,16))
C     Amplitude(s) for diagram number 26
      CALL FFV2_0(W(1,4),W(1,16),W(1,9),GC_649,AMP(26))
      CALL FFV10_3_1(W(1,3),W(1,7),GC_741,GC_768,MDL_MB,ZERO,W(1,16))
C     Amplitude(s) for diagram number 27
      CALL FFV2_0(W(1,4),W(1,16),W(1,9),GC_649,AMP(27))
      CALL FFV2_1(W(1,3),W(1,7),GC_740,MDL_MB,ZERO,W(1,16))
C     Amplitude(s) for diagram number 28
      CALL FFV2_0(W(1,4),W(1,16),W(1,9),GC_649,AMP(28))
...
C     Amplitude(s) for diagram number 29
      CALL FFV2_0(W(1,16),W(1,6),W(1,7),GC_649,AMP(29))
      CALL FFFF14_6_3(W(1,4),W(1,3),W(1,6),GC_586,GC_124,ZERO,ZERO,W(1
     $ ,16))
C     Amplitude(s) for diagram number 30
      CALL FFV2_0(W(1,5),W(1,16),W(1,7),GC_649,AMP(30))
      CALL FFFF10_11_20_6_110_2(W(1,4),W(1,5),W(1,6),GC_14,GC_353
     $ ,GC_351,GC_566,GC_350,MDL_MB,ZERO,W(1,16))
C     Amplitude(s) for diagram number 31
      CALL FFV2_0(W(1,16),W(1,3),W(1,7),GC_649,AMP(31))
      CALL FFV1_2(W(1,1),W(1,8),GC_2,ZERO,ZERO,W(1,16))
...
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,16),W(1,2),W(1,8),GC_1,AMP(33))
...
C     Amplitude(s) for diagram number 35
      CALL FFV1_0(W(1,16),W(1,2),W(1,10),GC_1,AMP(35))
      CALL FFV2_8_2(W(1,1),W(1,11),GC_651,GC_660,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 36
      CALL FFV2_0(W(1,10),W(1,2),W(1,9),GC_649,AMP(36))
C     Amplitude(s) for diagram number 37
      CALL FFV2_5_0(W(1,16),W(1,2),W(1,11),GC_650,GC_660,AMP(37))
      CALL FFV2_8_2(W(1,1),W(1,13),GC_651,GC_660,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 38
      CALL FFV2_0(W(1,11),W(1,2),W(1,9),GC_649,AMP(38))
C     Amplitude(s) for diagram number 39
      CALL FFV2_5_0(W(1,16),W(1,2),W(1,13),GC_650,GC_660,AMP(39))
...
C     Amplitude(s) for diagram number 41
      CALL FFV2_5_0(W(1,16),W(1,2),W(1,14),GC_650,GC_660,AMP(41))
...
C     Amplitude(s) for diagram number 43
      CALL FFV2_5_0(W(1,16),W(1,2),W(1,15),GC_650,GC_660,AMP(43))
...
C     Amplitude(s) for diagram number 48
      CALL FFV2_0(W(1,4),W(1,15),W(1,9),GC_649,AMP(48))
      CALL FFV2_0(W(1,4),W(1,16),W(1,9),GC_649,AMP(49))
      CALL FFFF10_14_18_19_6_8_2(W(1,1),W(1,4),W(1,3),GC_472,GC_575
     $ ,GC_589,GC_592,GC_150,GC_471,ZERO,ZERO,W(1,16))
