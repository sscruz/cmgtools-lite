...
C     
     ...
     $ +1D0/2D0*(M1*(F2(6)*(V3(4)+CI*(V3(5)))+2D0*(F2(5)*1D0/2D0*(V3(3)
     ...
     $ )-V3(4)))))+(+1D0/2D0*(M1*(F2(6)*(V3(3)-V3(6))+2D0*(F2(5)*1D0
     $ /2D0*(V3(4)-CI*(V3(5))))))+F2(4)*(P1(0)*(-1D0)*(V3(3)+V3(6))
     ...
     $ *2D0*(V3(6)-V3(3))+2D0*(F2(4)*(V3(4)+CI*(V3(5)))))))
     ...
     $ +(P1(2)*(V3(5)-CI*(V3(4)))+P1(3)*(V3(6)-V3(3)))))+M1*(F2(3)*2D0
     $ *(+CI*(V3(5))-V3(4))+2D0*(F2(4)*(V3(3)+V3(6))))))
      END
