...
C     
      ...
      TMP27 = (P3(0)*V1(3)-P3(1)*V1(4)-P3(2)*V1(5)-P3(3)*V1(6))
      ...
      TMP19 = (V2(3)*V1(3)-V2(4)*V1(4)-V2(5)*V1(5)-V2(6)*V1(6))
      VERTEX = COUP*(TMP19*(-CI*(TMP20)+CI*(TMP21))+(TMP23*(-CI*(TMP24)
     $ +CI*(TMP22))+TMP25*(-CI*(TMP26)+CI*(TMP27))))
      END
