      SUBROUTINE M89_SMATRIXHEL(P,HEL,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     
      INTEGER USERHEL
      COMMON/M89_HELUSERCHOICE/USERHEL
C     ----------
C     BEGIN CODE
C     ----------
      USERHEL=HEL
      CALL M89_SMATRIX(P,ANS)
      USERHEL=-1

      END

      SUBROUTINE M89_SMATRIX(P,ANS)
C     
...
C     
C     Process: d d~ > t t~ mu+ mu- DIM6<=1 FCNC=0 / h
C     Process: s s~ > t t~ mu+ mu- DIM6<=1 FCNC=0 / h
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     
      ...
      COMMON/M89_BORN_BEAM_POL/POLARIZATIONS
      DATA ((POLARIZATIONS(I,J),I=0,NEXTERNAL),J=0,5)/NPOLENTRIES*-1/

C     
C     FUNCTIONS
C     
      LOGICAL M89_IS_BORN_HEL_SELECTED
...
C      only three external particles.
     ...
     $       -1.AND.(.NOT.M89_IS_BORN_HEL_SELECTED(IHEL))) THEN
              CYCLE
            ENDIF
            T=M89_MATRIX(P ,NHEL(1,IHEL),JC(1))
            IF(POLARIZATIONS(0,0).EQ.-1.OR.M89_IS_BORN_HEL_SELECTED(IHE
     $L)) THEN
              ANS=ANS+T
            ENDIF
      ...
      REAL*8 FUNCTION M89_MATRIX(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.6.5, 2018-02-03
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFV2_5_3(W(1,1),W(1,2),GC_650,GC_660,MDL_MZ,MDL_WZ,W(1,10))
      CALL FFV2_7_2(W(1,5),W(1,10),GC_650,GC_661,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,9),W(1,6),W(1,8),GC_3,AMP(13))
      CALL FFV2_7_1(W(1,6),W(1,10),GC_650,GC_661,ZERO,ZERO,W(1,16))
...
C     Amplitude(s) for diagram number 90
      ...
      CALL FFV1_2(W(1,1),W(1,8),GC_1,ZERO,ZERO,W(1,25))
C     Amplitude(s) for diagram number 91
      CALL FFV1_0(W(1,25),W(1,2),W(1,16),GC_1,AMP(91))
      CALL FFV1_2(W(1,1),W(1,16),GC_1,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 92
      CALL FFV1_0(W(1,10),W(1,2),W(1,8),GC_1,AMP(92))
C     Amplitude(s) for diagram number 93
      CALL FFV2_5_0(W(1,25),W(1,2),W(1,20),GC_650,GC_660,AMP(93))
      CALL FFV2_5_2(W(1,1),W(1,20),GC_650,GC_660,ZERO,ZERO,W(1,25))
C     Amplitude(s) for diagram number 94
      CALL FFV1_0(W(1,25),W(1,2),W(1,8),GC_1,AMP(94))
      CALL FFV1_2(W(1,1),W(1,11),GC_1,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 95
      CALL FFV1_0(W(1,8),W(1,2),W(1,16),GC_1,AMP(95))
C     Amplitude(s) for diagram number 96
      CALL FFV1_0(W(1,10),W(1,2),W(1,11),GC_1,AMP(96))
C     Amplitude(s) for diagram number 97
      CALL FFV2_5_0(W(1,8),W(1,2),W(1,20),GC_650,GC_660,AMP(97))
C     Amplitude(s) for diagram number 98
      CALL FFV1_0(W(1,25),W(1,2),W(1,11),GC_1,AMP(98))
      CALL FFV2_5_2(W(1,1),W(1,12),GC_650,GC_660,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 99
      CALL FFV1_0(W(1,11),W(1,2),W(1,16),GC_1,AMP(99))
C     Amplitude(s) for diagram number 100
      CALL FFV2_5_0(W(1,10),W(1,2),W(1,12),GC_650,GC_660,AMP(100))
C     Amplitude(s) for diagram number 101
      CALL FFV2_5_0(W(1,11),W(1,2),W(1,20),GC_650,GC_660,AMP(101))
C     Amplitude(s) for diagram number 102
      CALL FFV2_5_0(W(1,25),W(1,2),W(1,12),GC_650,GC_660,AMP(102))
      CALL FFV2_5_2(W(1,1),W(1,13),GC_650,GC_660,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 103
      CALL FFV1_0(W(1,12),W(1,2),W(1,16),GC_1,AMP(103))
C     Amplitude(s) for diagram number 104
      CALL FFV2_5_0(W(1,10),W(1,2),W(1,13),GC_650,GC_660,AMP(104))
C     Amplitude(s) for diagram number 105
      CALL FFV2_5_0(W(1,12),W(1,2),W(1,20),GC_650,GC_660,AMP(105))
C     Amplitude(s) for diagram number 106
      CALL FFV2_5_0(W(1,25),W(1,2),W(1,13),GC_650,GC_660,AMP(106))
      CALL FFV2_5_2(W(1,1),W(1,14),GC_650,GC_660,ZERO,ZERO,W(1,13))
C     Amplitude(s) for diagram number 107
      CALL FFV1_0(W(1,13),W(1,2),W(1,16),GC_1,AMP(107))
C     Amplitude(s) for diagram number 108
      CALL FFV2_5_0(W(1,10),W(1,2),W(1,14),GC_650,GC_660,AMP(108))
C     Amplitude(s) for diagram number 109
      CALL FFV2_5_0(W(1,13),W(1,2),W(1,20),GC_650,GC_660,AMP(109))
C     Amplitude(s) for diagram number 110
      CALL FFV2_5_0(W(1,25),W(1,2),W(1,14),GC_650,GC_660,AMP(110))
      CALL FFV2_5_2(W(1,1),W(1,15),GC_650,GC_660,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 111
      CALL FFV1_0(W(1,14),W(1,2),W(1,16),GC_1,AMP(111))
C     Amplitude(s) for diagram number 112
      CALL FFV2_5_0(W(1,10),W(1,2),W(1,15),GC_650,GC_660,AMP(112))
C     Amplitude(s) for diagram number 113
      CALL FFV2_5_0(W(1,14),W(1,2),W(1,20),GC_650,GC_660,AMP(113))
C     Amplitude(s) for diagram number 114
      CALL FFV2_5_0(W(1,25),W(1,2),W(1,15),GC_650,GC_660,AMP(114))
...
C     Amplitude(s) for diagram number 127
      CALL FFV1_0(W(1,15),W(1,2),W(1,16),GC_1,AMP(131))
      CALL FFV1_0(W(1,25),W(1,2),W(1,16),GC_1,AMP(132))
C     Amplitude(s) for diagram number 128
      CALL FFV2_5_0(W(1,15),W(1,2),W(1,20),GC_650,GC_660,AMP(133))
      CALL FFV2_5_0(W(1,25),W(1,2),W(1,20),GC_650,GC_660,AMP(134))
...
C     Amplitude(s) for diagram number 129
      CALL FFV1_0(W(1,1),W(1,25),W(1,16),GC_1,AMP(135))
      CALL FFV1_0(W(1,1),W(1,15),W(1,16),GC_1,AMP(136))
C     Amplitude(s) for diagram number 130
      CALL FFV2_5_0(W(1,1),W(1,25),W(1,20),GC_650,GC_660,AMP(137))
      CALL FFV2_5_0(W(1,1),W(1,15),W(1,20),GC_650,GC_660,AMP(138))
     ...
     $ -AMP(126)-AMP(128)-AMP(130)-AMP(132)-AMP(134)-AMP(136)-AMP(138))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        M89_MATRIX = M89_MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO

      END

      SUBROUTINE M89_GET_VALUE(P, ALPHAS, NHEL ,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     the include file with the values of the parameters and masses 
      ...
      IF (NHEL.NE.0) THEN
        CALL M89_SMATRIXHEL(P, NHEL, ANS)
      ELSE
        CALL M89_SMATRIX(P, ANS)
      ENDIF
      RETURN
      ...
      SUBROUTINE M89_INITIALISEMODEL(PATH)
C     ROUTINE FOR F2PY to read the benchmark point.    
      IMPLICIT NONE
      CHARACTER*512 PATH
CF2PY INTENT(IN) :: PATH
      ...
      LOGICAL FUNCTION M89_IS_BORN_HEL_SELECTED(HELID)
      IMPLICIT NONE
C     
C     CONSTANTS
C     
...
C     ----------
      ...
      DO I=1,NEXTERNAL
        ...
        ENDDO
        IF(.NOT.FOUNDIT) THEN
          M89_IS_BORN_HEL_SELECTED = .FALSE.
          RETURN
        ENDIF
      ENDDO
