...
C     Gamma(3,2,-1)*ProjM(-1,1)
C     
      SUBROUTINE FFV2_8_1(F2, V3, COUP1, COUP2, M1, W1,F1)
      IMPLICIT NONE
      COMPLEX*16 CI
      PARAMETER (CI=(0D0,1D0))
      COMPLEX*16 F2(*)
      ...
      CALL FFV8_1(F2,V3,COUP2,M1,W1,FTMP)
      DO I = 3, 6
        F1(I) = F1(I) + FTMP(I)
      ENDDO
      END
...
C     Gamma(3,2,-1)*ProjM(-1,1)
C     
      SUBROUTINE FFV2_7_1(F2, V3, COUP1, COUP2, M1, W1,F1)
      IMPLICIT NONE
      COMPLEX*16 CI
      PARAMETER (CI=(0D0,1D0))
      COMPLEX*16 F2(*)
      ...
      COMPLEX*16 FTMP(6)
      CALL FFV2_1(F2,V3,COUP1,M1,W1,F1)
      CALL FFV7_1(F2,V3,COUP2,M1,W1,FTMP)
      DO I = 3, 6
        F1(I) = F1(I) + FTMP(I)
      ENDDO
      END
