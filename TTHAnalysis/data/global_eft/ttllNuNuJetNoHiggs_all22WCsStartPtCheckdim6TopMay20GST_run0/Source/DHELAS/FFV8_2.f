...
C     
     ...
     $ *4D0*(V3(3)-V3(6))+4D0*(F1(6)*(+CI*(V3(5))-V3(4))))))
     ...
     $ )
      F2(5)= DENOM*(-4D0 * CI)*(F1(5)*(P2(0)*(V3(6)-V3(3))+(P2(1)
     $ *(V3(4)+CI*(V3(5)))+(P2(2)*(V3(5)-CI*(V3(4)))+P2(3)*(V3(6)-V3(3)
     $ ))))+(+1D0/4D0*(M2*(F1(4)*(+CI*(V3(5))-V3(4))+4D0*(F1(3)*(-1D0
     $ /4D0)*(V3(3)+V3(6)))))+F1(6)*(P2(0)*(V3(4)-CI*(V3(5)))+(P2(1)*(
     $ -1D0)*(V3(3)+V3(6))+(P2(2)*(+CI*(V3(3)+V3(6)))+P2(3)*(V3(4)-CI
     $ *(V3(5))))))))
      F2(6)= DENOM*(-4D0 * CI)*(F1(5)*(P2(0)*(V3(4)+CI*(V3(5)))+(P2(1)
     $ *(V3(6)-V3(3))+(P2(2)*(-CI*(V3(3))+CI*(V3(6)))-P2(3)*(V3(4)+CI
     $ *(V3(5))))))+(+1D0/4D0*(M2*(F1(4)*(V3(6)-V3(3))+4D0*(F1(3)*(
     $ -1D0/4D0)*(V3(4)+CI*(V3(5))))))+F1(6)*(P2(0)*(-1D0)*(V3(3)+V3(6)
