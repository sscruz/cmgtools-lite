...
C     Gamma(3,2,-1)*ProjM(-1,1)
C     
      SUBROUTINE FFV2_8_2(F1, V3, COUP1, COUP2, M2, W2,F2)
      IMPLICIT NONE
      COMPLEX*16 CI
      PARAMETER (CI=(0D0,1D0))
      COMPLEX*16 F2(6)
      ...
      CALL FFV8_2(F1,V3,COUP2,M2,W2,FTMP)
      DO I = 3, 6
        F2(I) = F2(I) + FTMP(I)
      ENDDO
      END
...
C     Gamma(3,2,-1)*ProjM(-1,1)
C     
      SUBROUTINE FFV2_7_2(F1, V3, COUP1, COUP2, M2, W2,F2)
      IMPLICIT NONE
      COMPLEX*16 CI
      PARAMETER (CI=(0D0,1D0))
      COMPLEX*16 F2(6)
      ...
      INTEGER*4 I
      CALL FFV2_2(F1,V3,COUP1,M2,W2,F2)
      CALL FFV7_2(F1,V3,COUP2,M2,W2,FTMP)
      DO I = 3, 6
        F2(I) = F2(I) + FTMP(I)
      ENDDO
      END
