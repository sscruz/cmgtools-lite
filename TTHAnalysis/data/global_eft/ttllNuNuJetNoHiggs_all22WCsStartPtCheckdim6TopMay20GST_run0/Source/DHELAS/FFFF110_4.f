...
C     
     ...
     $ * W4))
      F4(3)= DENOM*8D0 * CI * TMP16*(F3(5)*(P4(0)-P4(3))+F3(6)*(+CI
     $ *(P4(2))-P4(1)))
      F4(4)= DENOM*8D0 * CI * TMP16*(F3(5)*(-1D0)*(P4(1)+CI*(P4(2)))
     $ +F3(6)*(P4(0)+P4(3)))
      F4(5)= DENOM*8D0 * CI * F3(5)*M4*TMP16
      F4(6)= DENOM*8D0 * CI * F3(6)*M4*TMP16
      END
