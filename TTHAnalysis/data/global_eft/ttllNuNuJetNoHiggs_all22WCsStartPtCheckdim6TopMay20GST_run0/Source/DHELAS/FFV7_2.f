...
C     
     ...
     $ *2D0*(V3(3)-V3(6))+2D0*(F1(6)*(+CI*(V3(5))-V3(4))))))
     ...
     $ )
      F2(5)= DENOM*(-2D0 * CI)*(F1(5)*(P2(0)*(V3(6)-V3(3))+(P2(1)
     $ *(V3(4)+CI*(V3(5)))+(P2(2)*(V3(5)-CI*(V3(4)))+P2(3)*(V3(6)-V3(3)
     $ ))))+(+1D0/2D0*(M2*(F1(4)*(+CI*(V3(5))-V3(4))+2D0*(F1(3)*(-1D0
     $ /2D0)*(V3(3)+V3(6)))))+F1(6)*(P2(0)*(V3(4)-CI*(V3(5)))+(P2(1)*(
     ...
     $ *(V3(5))))))+(+1D0/2D0*(M2*(F1(4)*(V3(6)-V3(3))+2D0*(F1(3)*(
