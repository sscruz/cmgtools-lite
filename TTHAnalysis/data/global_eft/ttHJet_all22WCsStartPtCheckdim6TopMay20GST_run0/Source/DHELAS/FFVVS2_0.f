...
C     
      SUBROUTINE FFVVS2_0(F1, F2, V3, V4, S5, COUP,VERTEX)
      IMPLICIT NONE
      COMPLEX*16 CI
     ...
     $ *(V3(3)*(V4(3)+V4(6))+(V3(4)*(-1D0)*(V4(4)+CI*(V4(5)))+(V3(5)*(
     $ +CI*(V4(4))-V4(5))-V3(6)*(V4(3)+V4(6)))))))
      VERTEX = COUP*S5(3)*(-CI*(TMP11+TMP14)+CI*(TMP12+TMP13))
      END
...
C      Gamma(3,-2,-1)*Gamma(4,2,-2)*ProjP(-1,1)
C     
      SUBROUTINE FFVVS2_4_0(F1, F2, V3, V4, S5, COUP1, COUP2,VERTEX)
      IMPLICIT NONE
      COMPLEX*16 CI
      PARAMETER (CI=(0D0,1D0))
      COMPLEX*16 V3(*)
      ...
      COMPLEX*16 TMP
      COMPLEX*16 S5(*)
      CALL FFVVS2_0(F1,F2,V3,V4,S5,COUP1,VERTEX)
      CALL FFVVS4_0(F1,F2,V3,V4,S5,COUP2,TMP)
      VERTEX = VERTEX + TMP
      END
